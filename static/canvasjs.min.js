...
(function() {
    ...
    function hb(h) {
        if (!ib) {
            var n = !1,
                v = !1;
            "undefined" === typeof pa.Chart.creditHref ? ((h.creditHref = ga("iuuqr;..b`ow`rkr/bnl.")), (h.creditText = ga("B`ow`rKR/bnl"))) : ((n = h.updateOption("creditText")), (v = h.updateOption("creditHref")));
    ...
    y = Oa.Chart = (function() {
                    ...
                    if ((a++, !this.options.data[c].type || 0 <= n._supportedChartTypes.indexOf(this.options.data[c].type))) {
                        ...
                        null === b.color ?
                            ...
                            (b._colorSet =
                                ...
                                "ohlc" === b.type ||
                                "waterfall" === b.type ||
                                "boxAndWhisker" === b.type ? [this.selectedColorSet[0]] :
                ...
                m._animator.animate(
                    ...
                    function() {
                        ...
                        for (var a = 0; a < m.plotInfo.plotTypes.length; a++)
                            for (var e = m.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) e.plotUnits[d].targetCanvas = null;
                        b = null;
                        m.disableToolTip = !1;
                            ...
                            ("undefined" === typeof t.dataPoints[B].x && (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)),
                                ...
                                (a.axisX.logarithmic ?
                                    ...
                                    (a.axisY.logarithmic ?
                                        ...
                                        ((e = t.dataPointEOs[B].cumulativeSum - t.dataPointEOs[B - 1].cumulativeSum), 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || k)
                        ) {
                            if (!k && ((k = !0), 0 < B)) {
                                B -= 2;
                                continue;
        ...
        n.prototype._mouseEventHandler = function(a) {
            ...
            if (this.interactivityEnabled)
                ...
                (a.preventManipulation && a.preventManipulation(),
                    ...
                    Ga && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")), !e)
            ) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < x.length)
                        for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
                            if (
                                (x[t].getTime ? (g = x[t].x.getTime()) : (g = x[t].x), !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                                    !s(x[t].y) &&
                                    x[t].y.length &&
                ...
                for (var n = !1, n = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < A.length)
                        for (var C = 5 < r && x.bevelEnabled ? !0 : !1, l = 0; l < A.length; l++)
                            if (
                                (A[l].getTime ? (g = A[l].x.getTime()) : (g = A[l].x), !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                                    !s(A[l].y) &&
                                    A[l].y.length &&
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < g.length)
                        for (var r = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (
                                (g[f].getTime ? (h = g[f].x.getTime()) : (h = g[f].x), !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1])
                            ) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (
                                (r[f].getTime ? (k = r[f].x.getTime()) : (k = r[f].x), !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1])
                            ) {
        ...
        n.prototype.renderPie = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var D = 0; D < m.length; D++)
                    (C += Math.abs(m[D].y)), !a && "undefined" !== typeof m[D].indexLabel && null !== m[D].indexLabel && 0 < m[D].indexLabel.toString().length && (a = !0), !a && "undefined" !== typeof m[D].label && null !== m[D].label && 0 < m[D].label.toString().length && (a = !0);
                if (0 !== C) {
        ...
        n.prototype.renderFunnel = function(a) {
            ...
            function l() {
                ...
                for (var d, e, f, g, l, k, m = 1, n = 0; n < 2 * m; n++) {
                    for (
                        var r = I.length - 1; 0 <= r &&
                        !(0 <= p(r) && p(r),
                            (f = I[r]),
                            (g = f.textBlock),
                            (k = (l = q(r) < O.length ? I[q(r)] : null) ? l.textBlock : null),
                            (d = +f.height.toFixed(6)),
                            (e = +g.y.toFixed(6)), !f.isDirty && l && e + d + da > +k.y.toFixed(6) && ((d = g.y + d + da - k.y), (e = a(r, -d)), e < d && (0 < e && (d -= e), (e = a(q(r), d)), e != d))); r--
                    );
                    b();
                }
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, A = this.plotArea, C = 0.025 * A.width, D = 0.01 * A.width, z = 0, E = A.height - 2 * C, F = Math.min(A.width - 2 * D, 2.8 * A.height), J = !1, H = 0; H < x.length; H++
                )
                    if (
                        (!J && "undefined" !== typeof x[H].indexLabel && null !== x[H].indexLabel && 0 < x[H].indexLabel.toString().length && (J = !0), !J && "undefined" !== typeof x[H].label && null !== x[H].label && 0 < x[H].label.toString().length && (J = !0),
                ...
                if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
                    ...
                    if (-1 !== H) {
                        if (u.reversed)
                            for (F.push(Z), G = H.length - 1; 0 < G; G--)(Z += H[G]), F.push(Z);
                        else
                            for (G = 0; G < H.length; G++)(Z += H[G]), F.push(Z);
                        if (u.reversed)
                            for (G = 0; G < H.length; G++) F[G] < xa ? (a.push(L), D.push(V), (ca = G)) : (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * T) / ea));
                        else
                            for (G = 0; G < H.length; G++) F[G] < xa ? (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * T) / ea), (ca = G)) : (a.push(L), D.push(V));
        ...
        E.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                g = q;
                for (
                    c = this.intervalStartPosition; c <= e; c = parseFloat(
                        1e-12 > this.interval ?
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (
                                        ((this.sessionVariables.labelMaxHeight =
                                            ...
                                            (m = (k - (n + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) / Math.sin((Math.PI / 180) * Math.abs(-25))), !s(this.options.labelWrap))
                                    )
                                        this.labelWrap ?
                ...
                if (
                    ((f = s(this.options.labelMaxWidth) ? (0.3 * this.chart.width) >> 0 : this.options.labelMaxWidth),
                        (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? (0.3 * this.chart.height) >> 0 : 1.5 * this.labelFontSize), !this.chart.panEnabled && 1 <= this._labels.length)
                ) {
                    this.sessionVariables.labelFontSize = this.labelFontSize;
                    this.sessionVariables.labelMaxWidth = f;
                    this.sessionVariables.labelMaxHeight = l;
            ...
            if ("normal" === e) {
                for (var x = [], A = [], y = [], D = [], M = [], N = [], P = [], R = []; 4 > w;) {
                    var G = 0,
                        ...
                        $ = 0;
                    if (c && 0 < c.length)
                        for (y = [], g = O = 0; g < c.length; g++) y.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (O += y[g]), (L += c[g] && !m.isNavigator ? c[g].margin : 0);
                        ...
                        for (g = 0; g < a.length; g++)
                            ...
                            ((a[g].lineCoordinates.x1 = l),
                                ...
                                ((h = k = 0),
                                    ...
                                    (u = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))), !a[g] ||
                                !a[g].labelAutoFit ||
                                s(z) ||
                                s(E) ||
                                m.isNavigator ||
                ...
                for (N = []; 4 > w;) {
                    ...
                    if (m.panEnabled)
                        for (g = 0; g < c.length; g++) p[g] = s(m.sessionVariables.axisY.height) ? (m.sessionVariables.axisY.height = p[g]) : m.sessionVariables.axisY.height;
                    else
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && ((n = b[L].lineCoordinates.x2), (l = n - T));
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[y].dataPoint.y[0])), u = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (var x = 0; x < m[r].dataPoint.y.length; x++)(u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[x]))), u < v && ((v = u), (y = r));
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), A = (u = 0), r = (y = 0); r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (x = 0; x < m[r].dataPoint.y.length; x++)(u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[x]))), u < v && ((v = u), (y = r));
                    ...
                    if (
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), r = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (x = 0; x < m[r].dataPoint.y.length; x++)(u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[x]))), u < v && ((v = u), (y = r));
